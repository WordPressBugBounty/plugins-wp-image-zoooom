...
if ( ! function_exists( 'wp_image_zoooom_settings' ) ) {
	function wp_image_zoooom_settings() {
		...
		$settings = array(
			...
			'label0'                     => array(
				'label'        => 'Add zoom to static images:',
				'value'       => '<a href="#TB_inline?width=600&height=400&inlineId=add-zoooom-help" class="thickbox">Documentation</a>', 
				'input_form'  => 'text',
				'section'     => 'general',
			),
			'custom_class'               => array(
				'label'       => __( 'Add zoom to static images in bulk', 'wp-image-zoooom' ),
				'value'       => '',
				'input_form'  => 'input_text',
				'description' => __( 'Write the CSS style selectors of images.', 'wp-image-zoooom' ),
				'pro'        => true,
				'section'     => 'general',
			),
			'enable_mobile'              => array(
				'label'       => __( 'Enable on mobile devices', 'wp-image-zoooom' ),
				'value'       => false,
				'input_form'  => 'checkbox',
				'description' => __( 'Smartphones and tablets are mobile devices.', 'wp-image-zoooom' ),
				'section'     => 'general',
			),
			'enable_lightbox_zoom'       => array(
				'label'      => __( 'Enable inside lightboxes. <a href="#TB_inline?width=600&height=400&inlineId=supported-lightboxes" class="thickbox">See supported lightboxes</a>', 'wp-image-zoooom' ),
				'value'      => false,
				'input_form' => 'checkbox',
				'pro'        => true,
				'section'    => 'general',
			...
			'label1'                     => array(
				'label'       => __( 'With WooCommerce', 'wp-image-zoooom' ),
				'input_form'  => 'header',
				'value'       => '',
				'section'     => 'general',
			),
			'enable_woocommerce'         => array(
				'label'      => __( 'Enable on product images', 'wp-image-zoooom' ),
				'value'      => true,
				'input_form' => 'checkbox',
				'section'    => 'general',
			),
			'exchange_thumbnails'        => array(
				'label'       => __( 'Exchange the thumbnail with main image', 'wp-image-zoooom' ),
				'value'       => true,
				'input_form'  => 'checkbox',
			...
			'woo_variations'             => array(
				'label'      => __( 'Enable on images for variation products', 'wp-image-zoooom' ),
				'value'      => false,
				'input_form' => 'checkbox',
				'pro'        => true,
				'section'    => 'general',
			...
			'woo_cat'                    => array(
				'label'      => __( 'Enable on WooCommerce category pages', 'wp-image-zoooom' ),
				'value'      => false,
				'input_form' => 'checkbox',
				'section'    => 'general',
			),
			...
			'label2'                     => array(
				'label'       => __( 'With SureCart', 'wp-image-zoooom' ),
				'input_form'  => 'header',
				'value'       => '',
				'section'     => 'general',
			),
			...
			'label3'                     => array(
				'label'       => __( 'With galleries/carousels/sliders', 'wp-image-zoooom' ),
				'input_form'  => 'header',
				'value'       => '',
				'section'     => 'general',
			),
			'flexslider'                 => array(
				'label'       => __( 'FlexSlider container', 'wp-image-zoooom' ),
				'value'       => '',
				'input_form'  => 'input_text',
				'description' => __( 'Write the CSS selector of the div containing the FlexSlider gallery', 'wp-image-zoooom' ),
				'pro'        => true,
				'section'     => 'general',
			),
			'owl'                        => array(
				'label'       => __( '<a href="https://owlcarousel2.github.io/OwlCarousel2/" target="_blank">Owl Carousel</a> container', 'wp-image-zoooom' ),
				'value'       => '',
				'input_form'  => 'input_text',
				'description' => __( 'Write the CSS selector of the div containing the Owl Carousel gallery', 'wp-image-zoooom' ),
				'pro'        => true,
				'section'     => 'general',
			),
			'flickity'                   => array(
				'label'       => __( '<a href="https://flickity.metafizzy.co/" target="_blank">Flickity Carousel</a> container', 'wp-image-zoooom' ),
				'value'       => '',
				'input_form'  => 'input_text',
				'description' => __( 'Write the CSS selector of the div containing the Flickity Carousel gallery', 'wp-image-zoooom' ),
				'pro'        => true,
				'section'     => 'general',
			),
			'swiper'                     => array(
				'label'       => __( '<a href="http://idangero.us/swiper/" target="_blank">Swiper slider</a> container', 'wp-image-zoooom' ),
				'value'       => '',
				'input_form'  => 'input_text',
				'description' => __( 'Write the CSS selector of the div containing the Swiper slider', 'wp-image-zoooom' ),
				'pro'        => true,
				'section'     => 'general',
			),
			'slick'                      => array(
				'label'       => __( '<a href="https://kenwheeler.github.io/slick/" target="_blank">Slick carousel</a> container', 'wp-image-zoooom' ),
				'value'       => '',
				'input_form'  => 'input_text',
				'description' => __( 'Write the CSS selector of the div containing the Slick carousel gallery', 'wp-image-zoooom' ),
				'pro'        => true,
				'section'     => 'general',
			),
			'huge_it_gallery'            => array(
				...
				'value'       => '',
				'input_form'  => 'input_text',
				'description' => __( 'Write comma separated ids for adding the zoom to more than one Huge IT gallery.', 'wp-image-zoooom' ),
				'pro'        => true,
				'section'     => 'general',
			),
