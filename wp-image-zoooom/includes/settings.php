	...
	function wp_image_zoooom_settings() {
		...
		$settings = array(
			...
			'flexslider'                 => array(
				...
				'value'       => '',
				'input_form'  => 'input_text',
				'description' => __( 'If the images are in a Woo FlexSlider gallery, then type in here the CSS selector of the div containing the FlexSlider gallery', 'wp-image-zoooom' ),
				'pro'         => true,
				'section'     => 'general',
			),
			'owl'                        => array(
				...
				'value'       => '',
				'input_form'  => 'input_text',
				'description' => __( 'If the images are in a Owl Carousel gallery, then type in here the CSS selector of the div containing the Owl Carousel gallery', 'wp-image-zoooom' ),
				'pro'         => true,
				'section'     => 'general',
			),
			'flickity'                   => array(
				...
				'value'       => '',
				'input_form'  => 'input_text',
				'description' => __( 'If the images are in a Flickity Carousel gallery, then type in here the CSS selector of the div containing the Flickity Carousel gallery', 'wp-image-zoooom' ),
				'pro'         => true,
				'section'     => 'general',
			),
			'swiper'                     => array(
				...
				'value'       => '',
				'input_form'  => 'input_text',
				'description' => __( 'If the images are in a Swiper slider, then type in here the CSS selector of the div containing the Swiper slider', 'wp-image-zoooom' ),
				'pro'         => true,
				'section'     => 'general',
			),
			'slick'                      => array(
				...
				'value'       => '',
				'input_form'  => 'input_text',
				'description' => __( 'If the images are in a Slick carousel gallery, then type in here the CSS selector of the div containing the Slick carousel gallery', 'wp-image-zoooom' ),
				'pro'         => true,
				'section'     => 'general',
			),
